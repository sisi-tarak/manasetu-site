...
const TestimonialsSection = ({
  ...
  const testimonials: TestimonialData[] = [
    // Worker Testimonials
    {
      ...
      audience: "worker",
      content: `ManaSetu changed my college life completely! I earn ₹12,000+ every month doing data entry and content writing tasks. The verification process made me feel safe, and instant UPI payments mean I never have to wait for my money. Perfect for students like me who need flexible income.`,
      rating: 5,
    ...
    },
    {
      ...
      audience: "worker",
      content: `As a homemaker, ManaSetu gave me the perfect opportunity to earn from home. I do graphic design tasks during my free time and earn ₹8,000+ monthly. The flexible timing and instant payments make it ideal for managing household responsibilities.`,
      rating: 5,
    ...
    // Business Testimonials
    {
      ...
      audience: "business",
      content: `ManaSetu solved our biggest problem - finding reliable talent quickly. We've hired 50+ verified students for various projects and saved 60% on our operational costs. The quality of work and professionalism of workers is outstanding. Game-changer for small businesses!`,
      rating: 5,
    ...
    },
    {
      ...
      audience: "business",
      content: `The verification system on ManaSetu is incredible. Every worker we've hired has been professional and skilled. We've completed 100+ projects with zero payment disputes thanks to the escrow system. It's our go-to platform for finding quality talent.`,
      rating: 5,
    ...
    // Investor Testimonials
    {
      ...
      audience: "investor",
      content: `ManaSetu represents the future of India's gig economy. The community verification model and focus on trust sets them apart. With projected goals of ₹50L+ paid to workers and 10,000+ completed tasks in Year 1, the potential is impressive. Excited to be part of this journey.`,
      rating: 5,
